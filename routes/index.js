module.exports = (io) => {
  ...
  router.post('/reservation', (req, res, next) => {
    ...
    if (!req.body.name) {
    ...
    } else if (!req.body.pedido) {

      render('Selecione seu pedido.');
      ...
      conn.query(
        "INSERT INTO tb_reservations (name, email, pedido, date, time) VALUES(?, ?, ?, ?, ?)",
        [
          req.body.name,
          req.body.email,
          req.body.pedido,
        ...
        (err, results) => {
          ...
          if (err) {
            ...
            render(null, 'Pedido realizado com sucesso!');
